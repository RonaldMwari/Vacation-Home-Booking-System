...
$pageTitle = $websiteSettings['title'];
$pageDescription = $websiteSettings['description']; // Add this line to retrieve the description
?>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-black px-lg-3 py-lg-2 shadow-sm sticky-top ">
    ...
    <a class="navbar-brand me-5 fw-bold fs-3 h-font text-white"><?php echo $pageTitle; ?></a>
    ...
    <div class="modal fade" id="loginModal" style="display: none;"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
