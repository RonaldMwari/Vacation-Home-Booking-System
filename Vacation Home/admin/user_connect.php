...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = $conn->prepare("INSERT INTO `user queries` (name, email, subject, message) VALUES (?, ?, ?, ?)")) {
    ...
    if ($stmt->execute()) {
        echo '<div class="alert alert-success mt-3" role="alert">Message sent successfully!</div>';
    } else {
...
<!-- Footer -->
<?php require('C:\xampp\htdocs\Vacation Home\inc\footer.php'); ?>
